        ...
        >
          ...
          <div className="relative px-8 py-14 sm:px-14 lg:px-20 lg:py-20 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12">
            ...
            <div className="flex flex-col">
              ...
              >
                Our support team is always ready. Reach out via WhatsApp for
            ...
            >
              ...
              <Link href="/contact">
                ...
                >
                  <Mail className="w-4 h-4 transition-colors duration-300 group-hover:text-gold" />
                  Contact Page
                  <ArrowUpRight className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 -translate-x-1 group-hover:translate-x-0 transition-all duration-300 text-gold" />
                </motion.button>
              </Link>
            </motion.div>
          </div>
