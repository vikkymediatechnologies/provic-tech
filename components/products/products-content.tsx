...
export function ProductsContent() {
  ...
  return (
    <div className="relative py-12 overflow-hidden bg-white dark:bg-[#080808]">
      ...
      {/* Ambient glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[50vw] h-80 pointer-events-none"
        style={{
          ...
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full h-10 pl-10 pr-4 rounded-xl text-sm
                ...
                focus:outline-none focus:border-gold/50 transition-all duration-200"
            />
          </div>

          <div className="flex items-center gap-2.5 flex-wrap">
            <PremiumSelect value={selectedCategory} onChange={handleCategoryChange} options={allCategoryOptions} />
            <PremiumSelect value={sortBy} onChange={setSortBy} options={sortOptions} />
          ...
          <div className="flex items-center justify-center gap-2 mt-14">
            ...
            <div className="flex items-center gap-1.5">
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                <motion.button key={page} whileHover={{ scale: 1.08 }} whileTap={{ scale: 0.95 }}
